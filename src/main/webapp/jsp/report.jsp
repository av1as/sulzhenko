...
<table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
 ...
 <%--For displaying Previous link except for the 1st page --%>
    <c:if test="${currentPage != 1}">
        <td><a href="/TimeKeeping/controller?action=show_report&page=${currentPage - 1}"><fmt:message key="previous"/></a></td>
    </c:if>
        ...
        <tr>
            <c:forEach begin="1" end="${noOfPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <td><a href="/TimeKeeping/controller?action=show_report&page=${i}">${i}</a></td>
    ...
    <c:if test="${currentPage lt noOfPages}">
        <td><a href="/TimeKeeping/controller?action=show_report&page=${currentPage + 1}"><fmt:message key="next"/></a></td>
    </c:if>
