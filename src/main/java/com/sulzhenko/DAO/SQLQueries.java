...
//            "WHERE password = ? ORDER BY account;";
        ...
        public static final String USER_HAS_ACTIVITY_AND_NOTIFICATION = "INNER JOIN user_activity\n" +
        ...
        public static final String FIND_CONNECTED_USERS = SELECT_ALL_USER_FIELDS + USER_HAS_ACTIVITY_AND_NOTIFICATION;
    }
